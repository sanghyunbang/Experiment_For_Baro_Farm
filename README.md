...
4. 실험용 토큰과 사용자 ID 준비는 [docs/TOKEN_AND_TEST_DATA.md](./docs/TOKEN_AND_TEST_DATA.md)를 먼저 본다.

## 문서 순서

- [docs/LOAD_TEST_GUIDE.md](./docs/LOAD_TEST_GUIDE.md)
- [docs/TOKEN_AND_TEST_DATA.md](./docs/TOKEN_AND_TEST_DATA.md)
- [docs/EXPERIMENT_PLAN.md](./docs/EXPERIMENT_PLAN.md)
- [docs/ENV_PRESETS.md](./docs/ENV_PRESETS.md)
- [docs/EXPERIMENT_MATRIX.md](./docs/EXPERIMENT_MATRIX.md)
- [docs/PROFILE_GUIDE.md](./docs/PROFILE_GUIDE.md)
- [docs/AWS_TWO_NODE_SETUP.md](./docs/AWS_TWO_NODE_SETUP.md)
...
상세 절차와 보안그룹, SSH 터널, EC2 역할 분리는 [docs/AWS_TWO_NODE_SETUP.md](./docs/AWS_TWO_NODE_SETUP.md)를 본다.
실험 토글 조합은 [docs/EXPERIMENT_MATRIX.md](./docs/EXPERIMENT_MATRIX.md), 추천 환경값은 [docs/ENV_PRESETS.md](./docs/ENV_PRESETS.md)를 본다.
